...
export const PrecisionManufacturingTwoTone = createIcon({
  path: (
    <>
      <Path opacity={0.3} d="m6.71 10 2.46 8h1.94l-4.3-8z" />
      <Circle cx={6} cy={7} opacity={0.3} r={1} />
  ...
  displayName: "PrecisionManufacturingTwoTone",
})
