...
import { ClipPath, Defs, Ellipse, G, Path, Use } from "react-native-svg"

export const MedicationLiquidTwoTone = createIcon({
  path: (
    <>
      <G opacity={0.3}>
        <Defs>
          <Path id="a" opacity={0.3} d="M4 8h10v11H4z" />
        </Defs>
  ...
  displayName: "MedicationLiquidTwoTone",
})
